...
--
-- Table structure for table `lab_handler`
--

DROP TABLE IF EXISTS `lab_handler`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `lab_handler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `lab_handler`
--

LOCK TABLES `lab_handler` WRITE;
/*!40000 ALTER TABLE `lab_handler` DISABLE KEYS */;
/*!40000 ALTER TABLE `lab_handler` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `laboratory_result` (
  ...
  `date` date DEFAULT NULL,
  `collected_by` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-11-25 17:37:37
